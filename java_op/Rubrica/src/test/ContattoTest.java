...
class ContattoTest {
	...
	void inserisciNumTelPresente() {
		...
		c1.inserisciNumTel("1234567892");
		assertEquals(false, c1.inserisciNumTel("1234567892"));
	...
	void eliminaNumTel() {
		...
		c1.inserisciNumTel("1234567892");
		assertEquals(true, c1.eliminaNumTel("1234567892"));
		assertEquals(0, c1.getNumeriTel().size());
	}
	...
	void eliminaNumTelNonPresente() {
		...
		assertEquals(false, c1.eliminaNumTel("1234567892"));
		assertEquals(0, c1.getNumeriTel().size());
	}
	...
	void matchNomeCorretto(){
		...
		assertEquals(true, c1.matchNome("Car"));
	...
	void matchNomeErrato(){
		Contatto c1 = new Contatto("Carlo", "musmarra@gmail.com");
		assertEquals(false, c1.matchNome("one"));
		
	}
	@Test
	void matchEmailCorretto(){
		Contatto c1 = new Contatto("Carlo", "musmarra@gmail.com");
		assertEquals(true, c1.matchEmail("ra@g"));	
	}
	
	@Test
	void matchEmailErrato(){
		Contatto c1 = new Contatto("Carlo", "musmarra@gmail.com");
		assertEquals(false, c1.matchEmail("one"));	
	...
	void equalsOggettoDiverso() {
		...
		assertEquals(false, c1.equals(42));
	}
